/*
 * Archivo: T_PREBAYDWFOLGU_612.java
 * Fecha: 2021-10-12T20:42:03Z
 *
 ...
 */
package com.cobiscorp.cobis.preba.services;
 ...
 * T_PREBAYDWFOLGU_612 - Clientes 
 *
 */
@Path("/PREBA/FRMLR/T_PREBAYDWFOLGU_612")
@Component
@Service({T_PREBAYDWFOLGU_612.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=PREBA)(task.submodule=FRMLR)(task.id=T_PREBAYDWFOLGU_612)(task.version=1.0.0))")
,@Reference(name="VW_CLIENTESCM_637", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CLIENTESCM_637)(view.version=1.0.0))")
...
public class T_PREBAYDWFOLGU_612 {
